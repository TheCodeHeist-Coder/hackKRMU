    ...
    <section className="w-full py-24 bg-linear-to-b from-gray-50 to-white">
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <div className="mt-20  relative flex flex-col md:flex-row items-center justify-between gap-15">
         ...
         <div className="no-complexity flex items-center justify-center px-8 py-12">
         
         <div className="border border-red-500 py-5 px-6 flex flex-col gap-3"> 
            <h3 className="text-2xl tracking-wider font-semibold font-starter"> Zero knowledge Architecture </h3>

            <p className="text-md tracking-wide text-gray-600"> SafeDesk is architecturally designed so that even system administrators cannot link a complaint to a specific employee. Your identity is not just hidden — it is technically impossible to recover. End-to-end encryption, metadata stripping, and role-based access controls ensure absolute confidentiality.
          </p>
